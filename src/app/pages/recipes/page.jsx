  ...
  return (
    <div className="relative mx-auto max-w-xs min-h-screen bg-gray-100 shadow-lg flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
        <Link href="/pages/recipescard/1">
          <article className="bg-white rounded-xl shadow overflow-hidden cursor-pointer hover:shadow-md transition">
            ...
            <div className="p-4 space-y-2">
              ...
              <p className="text-sm text-gray-600">
                Una deliciosa pasta con vegetales frescos
              </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link href="/pages/recipescard/2">
            <article className="bg-white rounded-lg shadow overflow-hidden flex flex-col cursor-pointer hover:shadow-md transition">
